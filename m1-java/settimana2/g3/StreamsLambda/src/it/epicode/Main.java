...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("lista di libri con prezzo maggiore a 100 euri");
		System.out.println(" ");
		order.products.stream()
        .filter(p -> p.getCategory().equals("book") && p.getPrice() > 100)
        .forEach(System.out::println);
		
		System.out.println("lista di prodotti per bambini ");
		System.out.println(" ");
		...
		System.out.println("lista di prodotti per ragazzi con sconto del 10%");
		System.out.println(" ");
		final double SCONTO = 0.1;
order.products.stream()
